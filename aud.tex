...
\title{}
\author{EE23BTECH11051 -  Rajnil Malviya \par Audio Filtering
}
\maketitle
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/audiounfilterd.wav
\end{lstlisting}
...
\\
\solution There are a lot of yellow lines between 440 Hz to 9.3 KHz.  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise. It clearly shows that tonal frequency is under 9kHz. And above 9kHz only noise is present.\\
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/unfiltered_song.png}
...
\item
\label{prob:output}
 Python code for removal of out of band noise and execute the code.
\\
\solution
\begin{lstlisting}
...
\end{lstlisting}
\item
The output of the python script in Problem \ref{prob:output} is the audio file ReducedNoise.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?\bigskip
\\
\solution The key strokes as well as background noise is subdued in the audio.  Also,  the signal is blank for frequencies above 9 kHz.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/reduced.png}
    \caption{Spectrogram of reduced sound}
    \label{fig:spectrogram_without_noise}
\end{figure}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/32.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/xnyn_plot.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\columnwidth]{figs/plot_of_xandyn.png}
...
\begin{align}
{\mathcal {Z}}\{x(n-r)\} &=\sum _{n=-\infty }^{\infty }x(n-1)z^{-n}
\\
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/H(z)fig.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/h(n)_impulse_response_plt.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/impulseresponse.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figs/impulse_response_of_ hn.png}
...
%
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/filter_out_using_convolution.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figs/yn_using_covolution.png}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/solution6.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/64.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/y(n)dft.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/amplitude.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/hnmag.py
\end{lstlisting}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figs/modh(n)plt.png}
...
\begin{lstlisting}
https://github.com/rajnilm/audio-filtering/blob/main/codes/filterresponse.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\solution The Sampling Frequency is 42.76KHz\bigskip
\item
