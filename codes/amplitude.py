...
# Parameters
input_file = "audiounfilterd.wav"
output_file_builtin = "audiounfilterd_filtered_builtin.wav"
output_file_custom = "audiounfilterd_filtered_custom.wav"
cutoff_frequency = 9000  # Hz
order = 4
max_time = 5  # seconds
